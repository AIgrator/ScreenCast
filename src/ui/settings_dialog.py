...
class SettingsPageWidget(QWidget):
    ...
    def init_ui(self):
        ...
        info = QLabel("Дефолт: 720p, 15 FPS, видео 1500 kbps, аудио 256 kbps, 48000 Hz")
...
class SettingsDialog(QDialog):
    ...
    def __init__(self, settings_manager, parent=None):
        super().__init__(parent)
        self.sm = settings_manager
        self.setWindowTitle("Настройки качества записи")
    ...
    def init_ui(self):
        ...
        self.page = SettingsPageWidget(self.sm, parent=self)
    ...
    def on_save(self):
        settings = self.page.get_settings()
